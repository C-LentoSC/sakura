        ...
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-md border border-secondary/5">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-pink-400 flex items-center justify-center text-white hover:scale-110 transition-transform duration-300">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-md border border-secondary/5">
            ...
            <form className="space-y-4 sm:space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 sm:py-4 bg-gradient-to-r from-primary to-pink-400 text-white font-semibold rounded-full hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
              >
